...
- State lưu cả password, API keys, private keys nếu resource có
- Nếu 2 người cùng apply, state thay đổi → merge Git rất khó vì file phức tạp
...
- So sánh: code vs state vs thực tế 
...
- count là số nguyên
- Truy cập từng cái bằng count.index 
